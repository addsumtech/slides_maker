<!-- Extracted from SKILL.md L91-194 -->
<!-- This file is loaded on-demand when the corresponding Step runs. -->
<!-- SKILL.md retains a skeleton summary + pointer to this file. -->

# Checkpoint Convention & Auto-Waiver Format

> The 🔴 CHECKPOINT convention, the per-deck AUTO WAIVER rules, delegated picks, and the checkpoint artifact format specifications.
