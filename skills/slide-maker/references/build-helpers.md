<!-- Extracted from SKILL.md Step 4 helper catalogue (L1159-1270) -->
<!-- This file is loaded on-demand when the corresponding Step runs. -->
<!-- SKILL.md retains a skeleton summary + pointer to this file. -->

# deckkit Build Helpers Catalogue

> The complete deckkit component catalogue organized by job: chrome, layout, text, colour, charts, diagrams, 2.5D, decision grids, editorial furniture, micro-viz, and more.
