...
访谈会展开成一个可点选的标签页问卷（主题 · 模板 · 用途受众 · 风格语言）：方向键切换、回车选择，每题都带现成选项，主题那页甚至会根据你近期的项目猜出候选。**逐题回答，正是让 deck 变成「你的」而不是通用款的关键**：受众、时长、现场还是自读、密度、语言、观感，都会影响方案。短句回答就行，**「你定」永远是合法答案**。
